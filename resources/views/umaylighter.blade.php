...
<div class="container" style="margin-top: 7rem;">
    <img src="{{ asset('asset/image/umaylighter1.png') }}" alt="" style="width: 80%; margin-left:8rem;">
</div>
...
<div class="container" style="margin-top: 4rem !important;">
    <div class="row">
        <div class="col-6">
            <img src="{{ asset('asset/image/photo15.png') }}" alt="" style="width: 100%; border-radius: 12px;">
        </div>

        <div class="col-6">
            <img src="{{ asset('asset/image/photo16.png') }}" alt="" style="width: 100%; border-radius: 12px;">
        </div>
    </div>
</div>
